...
export default function Experience() {
  return (
    <section id="experience" className="section py-20 bg-gray-950">
              ...
              <div className={`mb-${index === resumeData.experiences.length - 1 ? '0' : '12'}`}>
                <div className="flex flex-col md:flex-row bg-gray-800 rounded-lg shadow-md overflow-hidden">
                  ...
                  <div className="md:w-3/4 p-6">
                    <h4 className="text-xl font-semibold text-white mb-2">{experience.company}</h4>
                    <p className="text-gray-300 mb-4">{experience.location}</p>
                    ...
                    <div className="mt-4">
                      {experience.technologies.map((tech, techIndex) => (
                        <span key={techIndex} className="inline-block bg-gray-700 text-primary px-3 py-1 rounded-full text-sm font-medium mr-2 mb-2">
                          {tech}
                        </span>
                      ))}
                    </div>
