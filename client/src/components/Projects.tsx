...
export default function Projects() {
  return (
    <section id="projects" className="section py-20 bg-gray-950">
          ...
          {resumeData.projects.map((project, index) => (
            <FadeInSection key={index}>
              <motion.div
                ...
                className="bg-gray-800 rounded-lg shadow-md overflow-hidden transition-transform duration-300"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap mb-4">
                    {project.technologies.map((tech, techIndex) => (
                      <span key={techIndex} className="bg-gray-700 text-primary text-xs font-medium px-2.5 py-0.5 rounded mr-2 mb-2">
                        {tech}
                      </span>
                    ))}
                  </div>
